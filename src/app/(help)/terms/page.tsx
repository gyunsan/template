...
export const metadata: Metadata = {
  ...
  description: 'Find out our terms and conditions for using our website. ',
};
    ...
    <div className="w-full flex justify-center items-center   rounded-lg py-12">
      <div className="w-8/12">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-4xl font-bold tracking-tight  sm:text-6xl">Terms and Conditions</h2>
          <p className="m-6 text-xs">
            These terms and conditions outline the rules and regulations for the use of Vector Web's
            Website, located at
        ...
        <p>
          ...
          to use cooksa if you do not agree to take all of the terms and conditions stated on this
          page.
        </p>
        ...
        <h3 className="text-xl font-semibold py-6">Cookies</h3>

        <p>
          We employ the use of cookies. By accessing cooksa, you agreed to use cookies in agreement
          with Vector Web's Privacy Policy.{' '}
        </p>
        ...
        <h3 className="text-xl font-semibold py-6">License</h3>

        <p>
          Unless otherwise stated, Vector Web and/or its licensors own the intellectual property
          rights for all material on cooksa. All intellectual property rights are reserved. You may
          access this from cooksa for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul className="list-disc ml-6 m-2">
          <li>Republish material from cooksa</li>
          <li>Sell, rent or sub-license material from cooksa</li>
          <li>Reproduce, duplicate or copy material from cooksa</li>
          <li>Redistribute content from cooksa</li>
        </ul>
        ...
        <p>
          ...
          information in certain areas of the website. Vector Web does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do not reflect the views
          and opinions of Vector Web,its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Vector Web shall not be liable for the Comments or for any liability,
          damages or expenses caused and/or suffered as a result of any use of and/or posting of
          and/or appearance of the Comments on this website.
        </p>

        <p>
          Vector Web reserves the right to monitor all Comments and to remove any Comments which can
        ...
        <p>
          You hereby grant Vector Web a non-exclusive license to use, reproduce, edit and authorize
          others to use, reproduce and edit any of your Comments in any and all forms, formats or
          media.
        </p>

        <h3 className="text-xl font-semibold py-6">Hyperlinking to our Content</h3>
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of Vector Web; and (d) the link is in
        ...
        <p>
          ...
          linking to our website, you must inform us by sending an e-mail to Vector Web. Please
        ...
        <p>
          No use of Vector Web's logo or other artwork will be allowed for linking absent a
          trademark license agreement.
        </p>

        <h3 className="text-xl font-semibold py-6">iFrames</h3>
        ...
        <h3 className="text-xl font-semibold py-6">Content Liability</h3>
        ...
        <h3 className="text-xl font-semibold py-6">Your Privacy</h3>

        <p>Please read Privacy Policy</p>

        <h3 className="text-xl font-semibold py-6">Reservation of Rights</h3>
        ...
        <h3 className="text-xl font-semibold py-6">Removal of links from our website</h3>
        ...
        <h3 className="text-xl font-semibold py-6">Disclaimer</h3>
