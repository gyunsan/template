...
export const metadata: Metadata = {
  ...
  description:
    'This Privacy Policy document contains types of information that is collected and recorded by cooksa and how we use it.',
};
      ...
      <div className="w-8/12">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="m-6 text-xs ">
            At cooksa, accessible from https://cooksa.com, one of our main
            priorities is the privacy of our visitors. This Privacy Policy document contains types
            of information that is collected and recorded by cooksa and how we use it.
          </p>
        </div>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in cooksa. This
          policy is not applicable to any information collected offline or via channels other than
          this website.
        </p>
        <h3 className="text-xl font-semibold py-6">Consent</h3>

        <p>
          By using our website, you hereby consent to our Privacy Policy and agree to its terms.
        </p>

        <h3 className="text-xl font-semibold py-6">Information we collect</h3>
        ...
        <h3 className="text-xl font-semibold py-6">How we use your information</h3>
        ...
        <h3 className="text-xl font-semibold py-6">Log Files</h3>

        <p>
          cooksa follows a standard procedure of using log files. These files log visitors when they
          visit websites. All hosting companies do this and are a part of hosting services'
        ...
        <h3 className="text-xl font-semibold py-6">Cookies and Web Beacons</h3>

        <p>
          Like any other website, cooksa uses 'cookies'. These cookies are used to store information
        ...
        <h3 className="text-xl font-semibold py-6">Google DoubleClick DART Cookie</h3>
        ...
        <h3 className="text-xl font-semibold py-6">Our Advertising Partners</h3>

        <p>
          Some of the advertisers on our site may use cookies and web beacons. Our advertising
          partners are listed below. Each of our advertising partners has its own Privacy Policy for
        ...
        <h3 className="text-xl font-semibold py-6">Advertising Partners Privacy Policies</h3>
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on cooksa,
        ...
        <p>
          Note that cooksa has no access to or control over these cookies that are used by
          third-party advertisers.
        </p>

        <h3 className="text-xl font-semibold py-6">Third Party Privacy Policies</h3>

        <p>
          cooksa's Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <h3 className="text-xl font-semibold py-6">GDPR Data Protection Rights</h3>
        ...
        <h3 className="text-xl font-semibold py-6">Children's Information</h3>
        ...
        <p>
          cooksa does not knowingly collect any Personal Identifiable Information from children
