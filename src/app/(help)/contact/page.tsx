...
export const metadata: Metadata = {
  title: 'Contact',
  description:
    "Have a question, feedback, or just want to say hello? We'd love to hear from you! Reach out to us through our form, and our team will get back to you as soon as possible.",
};

export default function Contact() {
  return (
    <div className="relative isolate  rounded-lg">
        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg leading-8 ">
              ...
              Reach out to us through our form, and our team will get back to you as soon as
              possible.
            </p>
            <dl className="mt-10 space-y-4 text-base leading-7 ">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="hover:" href="mailto:hello@example.com">
                    info@cooksa.com
                  </a>
                </dd>
              </div>
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full rounded-md border-0 px-3.5 py-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div>
